...
![AI](https://img.shields.io/badge/Intelligence%20Artificielle-000000?style=for-the-badge&logo=openai&logoColor=white)
...
- Configuration d'un réseau pour environnement bancaire
- Configuration d'un réseau pour établissement scolaire
- Déploiement et configuration d'équipements de sécurité pour infrastructures réseau

### 🛡️ Cybersécurité
- Analyse et durcissement de serveurs Linux
- Simulations d'attaques à des fins d'entraînement : DDoS, phishing, Man-in-the-Middle
...
| Établissement | Diplôme / Programme | Période |
|---|---|---|
| Université Polytechnique de Man | Licence Mathématiques, Informatique, Physique, Chimie (MIPC) | 2022 |
